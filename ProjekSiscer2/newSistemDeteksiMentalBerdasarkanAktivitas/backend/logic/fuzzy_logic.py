...
if __name__ == '__main__':
    ...
    print(f"Stress: {result1['stress_value']} ({result1['category']})")
    print(f"Screen MF: {result1['fuzzy_details']['screen_membership']}")
    
    # Test Case 2
    print("\n[TEST 2] Screen Rendah + Suhu Nyaman + Humid Ideal")
    result2 = calculate_stress(1.5, 24, 55, 0.2)
    print(f"Stress: {result2['stress_value']} ({result2['category']})")
    
    # Test Case 3
    print("\n[TEST 3] Screen Sedang + Kondisi Normal")
    result3 = calculate_stress(6, 25, 60, 1.5)
    print(f"Stress: {result3['stress_value']} ({result3['category']})")
